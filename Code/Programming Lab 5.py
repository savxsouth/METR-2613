...
# -*- coding: utf-8 -*-
"""
Created on Thu Apr 21 15:12:52 2022
...
if __name__ == "__main__":
    ...
    ax.set_title("NWC0 Wind Speed and Gust")
    ax.plot(daystats['TIMESTAMP'],daystats['WSPD'], color = 'green', linestyle = '--', label = 'Wind Speed') 
    ax.set_xlim([settings['start_date'],settings['end_date']+timedelta(minutes=5)]) 
    ax.xaxis.set_major_formatter(mpl.dates.DateFormatter('%m-%d-%Y \n %H:%M Z')) 
    ax.set_xlabel('Wind Speed (m/s)')
    
    ax.plot(daystats['TIMESTAMP'],daystats['WMAX'], color = '#000099', linestyle = '-', label = 'Wind Gust')  
    ax.set_ylim(0,3)  
